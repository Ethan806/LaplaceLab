...
def insert_into_excel_variable_list(item_name, item_value):
    ...
    workbook = load_workbook(variables_xl_path)
    ...
    workbook.save(variables_xl_path)
...
def navigation_col_xl(entry):
    ...
    if "=" in entry:
        ...
        else if "+" and"-" and "/" and "*" and "array" not in entry2 :
            insert_into_excel_variable_list(k,b);
            
        else if "+" and"-" and "/" and "*" in entry2:
            import sympy;
            insert_into_excel_variable_list(k,sympy.simpify(entry2))
        else if "array" in entry2:
